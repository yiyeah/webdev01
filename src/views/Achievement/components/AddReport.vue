        ...
        <el-card class="box-card">
          ...
          >
            ...
            <el-form-item prop="title">
              ...
              <el-input v-model="formData.title" placeholder="请输入报告的标题"></el-input>
            </el-form-item>
            ...
            <el-form-item prop="number">
              <template #label>
                <div style="font-size:20px; font-weight:600">报告编号</div>
              </template>
              <el-input v-model="formData.number" placeholder="请输入编号" style="width:350px"></el-input>
            </el-form-item>
            <el-form-item prop="institution">
              <template #label>
                <div style="font-size:20px; font-weight:600">研究机构</div>
              </template>
              <el-input v-model="formData.institution" placeholder="请输入机构" style="width:350px"></el-input>
            </el-form-item>
            <el-form-item>
              ...
              <el-dialog title="上传确认" :visible.sync="showBox" :show-close="false" :close-on-click-modal="false" width="25%">
                <div style="font-size:15px">确认上传该报告吗？</div>
                <template #footer>
